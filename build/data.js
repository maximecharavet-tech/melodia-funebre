...
const OPTIONS = [
  ...
  { id: 'plaque', prix: 79,
    titre: 'Plaque à QR code — écouter sur le lieu de repos',
    aide: "Un code discret, gravé sur une plaque posée près de la sépulture. On le scanne avec un téléphone et l'hommage se met à jouer, là, devant elle. Nous fournissons la page et le fichier de gravure ; votre agence funéraire réalise la plaque." },
  { id: 'urgence', prix: 199,
