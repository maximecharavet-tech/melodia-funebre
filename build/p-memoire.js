...
const musiquePersoDefunt = page({
  ...
  fil: 'Le registre',
  title: 'Musique personnalisée pour un défunt : trouver le style qui lui ressemble | Melodia Funèbre',
...
const hommageMusicalDefunt = page({
  ...
  desc: "Morceau qu’il aimait, musicien sur place, chorale, sa propre voix, montage sonorisé, chanson d’un proche, œuvre composée : ce que chaque forme apporte, et ce qu’elle coûte.",
...
const dernierHommageMusical = page({
  ...
  desc: "Le fichier, la page hommage, le QR code gravé : ce que devient une œuvre d’hommage après le jour même, à qui elle appartient, et ce qui se passe si le prestataire disparaît.",
